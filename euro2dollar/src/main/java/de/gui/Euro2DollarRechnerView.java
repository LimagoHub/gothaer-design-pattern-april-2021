...
public class Euro2DollarRechnerView extends Frame implements IEuro2DollarRechnerView {
	...
	@Override
	public void setPresenter(final IEuro2DollarPresenter presenter) {
	...
	@Override
	public void setRechnenEnabled(final boolean enabled) {
	 ...
	 */
	@Override
	public void setEuro(final String euro) {
	 ...
	 */
	@Override
	public void setDollar(final String dollar) {
